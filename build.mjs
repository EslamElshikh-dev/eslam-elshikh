...
function footer(language = "ar") {
  ...
  const exploreLinks = isEnglish
    ...
    : `<a href="/about/">عن إسلام</a><a href="/projects/">أعمال المواقع</a><a href="/google-maps-projects/">أعمال خرائط Google</a><a href="/local-seo/riyadh/">السيو المحلي في الرياض</a><a href="/google-ads/">إعلانات جوجل</a><a href="/google-expert/">خبير خرائط جوجل</a><a href="/blog/">المدونة</a><a href="/contact/">تواصل</a>`;
...
function aboutPage() {
  ...
  return page({
    ...
    description: "تعرّف على المهندس إسلام الشيخ، مهندس أمن سيبراني ومطور مواقع وبرمجيات في الرياض ومتخصص خرائط Google، مع مشروعات منشورة في تطوير الويب والذكاء الاصطناعي وخرائط جوجل والسيو المحلي.",
    path: "/about/",
    active: "about",
    body,
...
function googleExpertPage() {
  ...
  const body = `${innerHero({ eyebrowText: "متخصص خرائط Google · الرياض والسعودية", title: "إسلام الشيخ — خبير خرائط جوجل والملفات التجارية", lead: "أنا إسلام الشيخ، متخصص في خرائط Google والملفات التجارية. أساعد أصحاب الأنشطة على حل مشكلات التحقق والتعليق وإثبات الملكية وتحسين بيانات النشاط ورفع كفاءة الظهور في نتائج البحث وخرائط Google من خلال حلول عملية متوافقة مع السياسات.", path: "/google-expert/", crumbs: [{ name: "خبير خرائط جوجل", path: "/google-expert/" }], aside: `<span class="google-mark">G</span><strong>خبرة موثقة في Google Maps</strong><p>مساهمات عملية في منتجات Google ونماذج ملفات تجارية منشورة يمكن مراجعتها مباشرة.</p>` })}
...
${finalCta("ملفك التجاري معلق أو تعذر إثبات ملكيته؟", "أرسل رابط الملف ونص الإشعار وتسلسل التعديلات والمحاولات السابقة دون مشاركة كلمة مرور أو رمز تحقق.")}`;
  return page({ title: "المهندس إسلام الشيخ | خبير خرائط جوجل والملفات التجارية", description: "المهندس إسلام الشيخ، Eslam Elshikh، متخصص في خرائط Google والملفات التجارية بالسعودية وحلول التحقق والتعليق والظهور المحلي.", path: "/google-expert/", active: "google", body, schema: [expertService, faqSchema(faq), breadcrumbSchema([{ name: "الرئيسية", path: "/" }, { name: "خبير خرائط جوجل", path: "/google-expert/" }])] });
}
...
<section class="section-pad final-cta" id="contact"><div class="container"><div class="cta-panel reveal"><div><span class="eyebrow"><span></span>Start with context</span><h2>Turn a complex technical problem into a clear delivery plan.</h2><p>Share your goal, current state, relevant links, constraints, and expected timing. Do not include passwords, verification codes, or API keys.</p></div><div class="cta-actions">${button(`${site.whatsapp}?text=${encodeURIComponent("Hello Eng. Eslam, I would like to discuss a digital project.")}`, "Start on WhatsApp", "button-light", true)}<a class="cta-phone" href="mailto:${site.email}">${site.email}</a></div></div></div></section>`;
  return page({ title: `Eng. ${site.nameEn}`, description: "Eng. Eslam Elshikh is a cybersecurity engineer, software developer, Google Maps Specialist, AI agent builder, web developer, and SEO consultant based in Riyadh, Saudi Arabia.", path: "/en/", active: "home", body, lang: "en", modified: site.lastUpdated, schema: [faqSchema(englishHomeFaq)] });
}
