...
const topics = {
  "google-business-profile": {
    ...
    links: [
      ["/google-expert/", "خدمات متخصص خرائط Google"],
  ...
  "local-seo-saudi": {
    ...
    links: [
      ["/local-seo/riyadh/", "خدمات السيو المحلي في الرياض"],
      ["/blog/local-seo-riyadh-service-business/", "دليل الأنشطة الخدمية في الرياض"],
