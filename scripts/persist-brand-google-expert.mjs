...
const approvedLogo = "https://i.ibb.co/QjrZzVgv/7756-removebg-preview.webp";
...
for (const path of htmlFiles) {
  ...
  html = html
    ...
    .replaceAll("/assets/brand/eslam-elshikh-logo.webp", approvedLogo);
...
console.log(`Persisted approved external WebP brand and Google expert updates across ${htmlFiles.length} HTML files.`);
