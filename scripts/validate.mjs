...
for (const route of sitemapRoutes) {
  ...
  if (!html.includes('/assets/js/theme.js?v=3.6.3') || !html.includes('/assets/js/analytics.js?v=3.6.3')) errors.push(`${route}: missing versioned theme or consent-based analytics script`);
