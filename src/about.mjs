export function renderAbout({ site, mapsCount, projectCount, profilePhoto, innerHero, icon, eyebrow, button, finalCta }) {
...
<section class="section-pad muted-section about-proof-section"><div class="container"><div class="about-proof-heading reveal"><div>${eyebrow("أدلة لا شعارات")}<h2>أرقام مرتبطة بعمل يمكنك مراجعته</h2></div><div class="about-proof-actions">${button("/projects/", "استعرض المواقع", "button-ghost")}${button("/google-maps-projects/", "استعرض أعمال الخرائط")}</div></div><div class="about-proof-strip reveal"><article><strong data-counter="472">472</strong><span>ملفًا تم دعم توثيقه</span><small>ملفات Google التجارية</small></article><article><strong data-counter="233">233</strong><span>مشكلة تمت معالجتها</span><small>حالات ملفات تجارية متنوعة</small></article><article><strong data-counter="${mapsCount}">${mapsCount}</strong><span>نموذج خرائط منشور</span><small>روابط عامة قابلة للفتح</small></article><article><strong data-counter="${projectCount}">${projectCount}</strong><span>مشروع ويب حيًا</span><small>نماذج منشورة ضمن معرض الأعمال</small></article></div></div></section>
